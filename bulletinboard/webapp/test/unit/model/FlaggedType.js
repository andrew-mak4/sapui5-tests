sap.ui.require(
    ...
    function (FlaggedType) {
        ...
        // In each QUnit module we define test cases for each condition. For a Boolean conversion there are just two cases, true and false.
        // So we expect that the integer value 1 is converted to true and everything else to false.
